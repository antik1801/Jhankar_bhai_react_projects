...
const Register = () => {
  ...
  const { createUser, googleSignIn, githubSignIn, updateUsers } =
  ...
  const handleRegister = (event) => {
    ...
    createUser(email, password)
      .then((result) => {
        ...
        updateUserProfile(user, name, photoLink);
        navigate("/")
      })
      .catch((error) => {
        console.log(error);
  ...
  const updateUserProfile = (user, userName, displayPhoto) => {
    updateUsers(user, userName, displayPhoto)
      .then(() => {})
      .catch((error) => {
        toast.error(error.message);
      });
