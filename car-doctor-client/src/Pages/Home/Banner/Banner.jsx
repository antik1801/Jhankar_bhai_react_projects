  ...
  return (
    <div className="carousel w-full h-[600px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute h-full flex transform  left-0 top-0 bg-gradient-to-r items-center rounded-xl from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-7 w-1/2 pl-12">
            <p className="text-7xl font-semibold ">Affordable Price For Car Servicing</p>
