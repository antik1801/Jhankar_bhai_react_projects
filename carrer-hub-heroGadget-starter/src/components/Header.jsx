  ...
  return (
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
       ...
       <Link className="sm:hidden md:block "><button className="py-[19px] px-[28px] border-[1px] bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white font-[600] font-manrope rounded-[8px]">
          Start Applying
        </button>
        </Link>  
